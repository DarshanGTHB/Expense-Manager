...
const SignUp = ({ setUserId, signUpBtn }) => {
    ...
    const handleOTP = () => {
        if (formData.ID === '' || formData.Name === '' || formData.Email === '' || formData.Phone === '' || formData.Pswd1 === ''  || formData.Balance === '') {
            setOTPSent(-1)
            ...
            setOTPSent(-1)
            setWarn('Enter valid phone number!')
        }else {
            fetch("/userId", {
                method: "POST",
                headers: {
                ...
                <div className="content">
                    <div className="user-details">
                        <div className="input-box">
                            <input type="text" placeholder="Enter User ID" required name="ID" id="User_Id" onChange={handleInput} />
                        </div>
                        <div className="input-box">
                            <input type="text" placeholder="Enter your name" required name="Name" id="User_Name" onChange={handleInput} />
                        </div>
                        <div className="input-box">
                        ...
                        <div className="input-box">
                            <input type="number" placeholder="Enter Opening Balnce" required name="Balance" id="Balance" onChange={handleInput} />
                        </div>
