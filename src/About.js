            ...
            <div className="row">
                <div className='container1'>
                    <div className="column">
                        ...
                        <div className='icons'>
                            <div className='icon'><a href='https://www.instagram.com/devesh_1217/'><img src={insta} alt='Instagram'/></a></div>
                            <div className='icon'><a href='https://www.linkedin.com/in/devesh1217/'><img src={linkedin} alt='LinkedIn'/></a></div>
                            <div className='icon'><a href='https://github.com/devesh1217'><img src={git} alt='GitHub'/></a></div>
                            <div className='icon'><a href='mailto:devesh1217@yahoo.com'><img src={mail} alt='Email'/></a></div>
                        </div>
                </div>
                <div className='container1'>
                    <div className="column">
                        ...
                        <div className='icons'>
                            <div className='icon'><a href='#'><img src={insta} alt='Instagram'/></a></div>
                            <div className='icon'><a href='https://www.linkedin.com/in/hanusha-jain-332b06288?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'><img src={linkedin} alt='LinkedIn'/></a></div>
                            <div className='icon'><a href='https://github.com/HanushaJain66'><img src={git} alt='GitHub'/></a></div>
                            <div className='icon'><a href='mailto:hanushajain04@gmail.com'><img src={mail} alt='Email'/></a></div>
                        </div>
                </div>
                <div className='container1'>
                    <div className="column">
                        ...
                        <div className='icons'>
                            <div className='icon'><a href='https://instagram.com/v_darshan_2510?igshid=MzMyNGUyNmU2YQ=='><img src={insta} alt='Instagram'/></a></div>
                            <div className='icon'><a href='#'><img src={linkedin} alt='LinkedIn'/></a></div>
                            <div className='icon'><a href='#'><img src={git} alt='GitHub'/></a></div>
                            <div className='icon'><a href='mailto:u22cs030@coed.svnit.ac.in'><img src={mail} alt='Email'/></a></div>
                        </div>
                </div>
                <div className='container1'>
                    <div className="column">
                        ...
                        <div className='icons'>
                            <div className='icon'><a href='https://instagram.com/_lavanya_pinjarkar_?igshid=MzMyNGUyNmU2YQ=='><img src={insta} alt='Instagram'/></a></div>
                            <div className='icon'><a href='http://www.linkedin.com/in/lavanya-pinjarkar-616384277'><img src={linkedin} alt='LinkedIn'/></a></div>
                            <div className='icon'><a href='https://github.com/Lavanya5904'><img src={git} alt='GitHub'/></a></div>
                            <div className='icon'><a href='mailto:u22cs064@coed.svnit.ac.in'><img src={mail} alt='Email'/></a></div>
                        </div>
                </div>
            </div>
